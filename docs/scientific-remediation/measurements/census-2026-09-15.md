...
650 profiles, 5775 comparisons, bundle `sha256:daed2c1f284d...`.

**UNKNOWN 32.5%** &middot; INCOMPATIBLE 45.0% &middot; EXACT 11.3% &middot; DIRECT_COMPATIBLE 0.0%
...
| `unit-convertible` | LOSSLESS_CONVERSION_AVAILABLE 650 | Both ports declare measurement.unit, g against kg. Same quantity, so a lossless conversion. |
